...
function CreateDrawer() {
    ...
    var listItems = "Español::[fa-flag-o],English::[fa-flag-o],Deutsch::[fa-flag-o],日本::[fa-flag-o],中国::[fa-flag-o],Português::[fa-flag-o],Français::[fa-flag-o],Device::[fa-flag-o]";
...
function idioma( title, body, type, index ) {
    ...
    title = title.replace(/Device/gi,'multi');
...
function predeterminados() {
    ...
    var list = "Inicio,Español,English,Deutsch,日本,中国,Português,Français," + todo;
